...
describe "Editing todo items" do
  let!(:todo_list) { TodoList.create(title: "Your cool tasks", description: "buy pizza ingredients") }
  ...
  context "with completed items" do
    let!(:completed_todo_item) { todo_list.todo_items.create(content: "made a pizza", completed_at: 5.minutes.ago) }
